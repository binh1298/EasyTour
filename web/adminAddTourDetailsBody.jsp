                ...
                <div class="sidebar-wrap">
                    <div class="side search-wrap animate-box">
                        ...
                        <form action="MainController" method="POST" class="colorlib-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-field">
                                            <i class="icon fas fa-key"></i>
                                            <input type="text" name="numberOfJourneys" value="${requestScope.tourDetailsDTO.numberOfJourneys}" id="date" class="form-control" placeholder="">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-field">
                                            <i class="icon fas fa-key"></i>
                                            <input type="text" name="tourDetailsID" value="${requestScope.tourDetailsDTO.tourDetailsID}" id="date" class="form-control" placeholder="">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-field">
                                            <i class="icon fas fa-key"></i>
                                            <input type="text" name="creatorUsername" value="${sessionScope.USERNAME}" id="date" class="form-control" placeholder="" readonly="true">
                                        </div>
                            ...
                            <div class="row">
                                <<div class="col-md-12">
                                    <input type="submit" name="submit" id="submit" value="Add Details" class="btn btn-primary btn-block">
                                </div>
                            </div>  
                        </form>
                    </div>
