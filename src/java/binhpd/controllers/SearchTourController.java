...
public class SearchTourController extends HttpServlet
{
    ...
    private static final String PAGANIZE = "SearchTourPagingController";
//    private static final String SUCCESS = "searchTour.jsp";
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            ArrayList<TourDetailsDTO> list = dao.searchAvailableTour(dto);
            TourJourneyDAO jDao = new TourJourneyDAO();
            ArrayList<String> images = new ArrayList<>();
            for (TourDetailsDTO tourDetailsDTO : list)
            {
                images.add(jDao.getJourneyImagesDirectory(tourDetailsDTO.getTourDetailsID()).get(0));
            }
            HttpSession session = request.getSession();
            session.setAttribute("AVATAR", images);
