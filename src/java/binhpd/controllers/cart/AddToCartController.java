...
public class AddToCartController extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            TourDetailsDTO dto = dao.searchTourForCart(tourDetailsID);
            TourJourneyDAO jDao = new TourJourneyDAO();
            ArrayList<String> imagesDir = jDao.getJourneyImagesDirectory(tourDetailsID);
            cartObj.addToCart(dto, imagesDir);
            session.setAttribute("CART", cartObj);
            request.setAttribute("INVALID_CART", false);
            url = SUCCESS;
        } catch (Exception e)
        {
