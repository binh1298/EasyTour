...
{   
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            {
                url = ADD;
            } else if(submit.equals("Update Cart"))
            {
                url = UPDATE;
            } else if(submit.equals("Confirm Cart"))
            {
                url = CONFIRM;
            ...
            {
                request.setAttribute("ERROR", "Your command is invalid!");
                url = ERROR;
            }
        } catch (Exception e)
        {
            log("ERROR at CartController: " + e.getMessage());
        } finally
        {
